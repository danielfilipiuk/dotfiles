...
uniform float light_brightness = 2;// Scaling value for the brightness of the bloom effect

uniform float base_brightness = 2;// Scaling value for the brightness of the bright pixels
