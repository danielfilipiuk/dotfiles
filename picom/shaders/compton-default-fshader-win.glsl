...
<html>
  <head>
      ...
      <title>File: compton-default-fshader-win.glsl
| Debian Sources
</title>
  ...
  <ul>
    ...
    <li><a href="/doc/about/">About</a></li>
      ...
      <p id="breadcrumbs"><a href="/">sources</a> / <a href="/src/picom">picom</a> / <a href="/src/picom/13-1">13-1</a> / compton-default-fshader-win.glsl</p>
    </header> <!-- end header -->
...
<h2>File: compton-default-fshader-win.glsl</h2>
...
<table id="file_metadata">
  <tr>
    ...
    | stat: -rw-r--r-- 233 bytes
    </td>
    <td style="text-align: right;">
    <a id="link_parent_folder" href="/src/picom/13-1">parent folder</a>
    | <a id="link_download" href="/data/main/p/picom/13-1/compton-default-fshader-win.glsl">download</a>
    
    | <a id="link_duplicates" href="/sha256/?checksum=e74292b2995a19265d815506f69b03d208b1bc1f5e26fca0abe8c8ddbd7180a4&amp;page=1">
	  duplicates (8)</a>
...
<table id="codetable">
  <tr>
    <td>
      <pre id="sourceslinenumbers"><a id="L1" href="#L1">1</a><br /><a id="L2" href="#L2">2</a><br /><a id="L3" href="#L3">3</a><br /><a id="L4" href="#L4">4</a><br /><a id="L5" href="#L5">5</a><br /><a id="L6" href="#L6">6</a><br /><a id="L7" href="#L7">7</a><br /><a id="L8" href="#L8">8</a><br /><a id="L9" href="#L9">9</a><br /><a id="L10" href="#L10">10</a><br /><a id="L11" href="#L11">11</a><br /></pre>
    </td>
    <td>
...
</span><span id="line7" class="codeline ">	if (invert_color)
</span><span id="line8" class="codeline ">		c = vec4(vec3(c.a, c.a, c.a) - vec3(c), c.a);
</span><span id="line9" class="codeline ">	c *= opacity;
</span><span id="line10" class="codeline ">	gl_FragColor = c;
