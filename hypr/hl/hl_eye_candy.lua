...
---------------------------------------------------------------
        glow = {
        	...
        	render_power = 5, --in what power to render the falloff (more power, the faster the falloff) [1 - 4]
		color =  "rgba(23e0d5dd)",--glow’s color. Alpha dictates glow’s opacity.
		color_inactive = "rgba(23e0d511)",
			--#23e0d511
        },
---------------------------------------------------------------
        --motion_blur = {
