...
{ mouse = true },
{description = "drag window with mouse+super"})
-- tile / float window wiht super+left click
hl.bind(mainMod .. " + mouse:272", hl.dsp.window.float(),
{ mouse = true, click = true },
{description = "float window on click+super"}) 
-- resize window with super + right click
hl.bind(mainMod .. " + mouse:273", hl.dsp.window.resize(),
{ mouse = true },
{description = "resize window with mouseright+super"})
