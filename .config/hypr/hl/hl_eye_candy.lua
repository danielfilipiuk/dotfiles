...
---------------------------------------------------------------
        col = {
            ...
            inactive_border = { colors = {"rgba(48,30,46,.75)", "rgba(30,30,0,.75)"}, angle = 45 },
        },
---------------------------------------------------------------
...
---------------------------------------------------------------
        glow = {
        	enabled = true,
        	range = 20, --Glow range (“size”) in layout px
	...
	--color =  "rgba(23e0d522)",--glow’s color. Alpha dictates glow’s opacity.
		--color =  "rgba(228,226,222,.25)",--glow’s color. Alpha dictates glow’s opacity.
		color = { colors = {"rgba(238, 130, 238,.25)", "rgba(0, 255, 153, .25)"}, angle = 45 },
		color_inactive = { colors = {"rgba(48,30,46,.25)", "rgba(30,30,30,.25)"}, angle = 45 },
		--	rgba(48,30,46,.90);
			--#23e0d511
        },
---------------------------------------------------------------
