...
if pgrep -f "gpu-screen-recorder" >/dev/null; then
    ...
    notify "⬛ Monitor Recording stopped" "💾 Video saved."  && pw-play /home/daniel/sounds/stop-recording.oga --volume 0.25
    exit 0
fi
...
notify "🔴 Monitor Recording started" "$(basename "$FILENAME")" && pw-play /home/daniel/sounds/start-recording.oga --volume 0.25
